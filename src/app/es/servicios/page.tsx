    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        ...
        <div className="mt-16 flex flex-col items-center gap-4 rounded-2xl bg-nc-navy-800 px-8 py-14 text-center text-white">
          <h2 className="font-display text-3xl font-semibold">Maximiza el Potencial de tus Activos</h2>
          <p className="max-w-xl text-white/70">
            Descubre cómo optimizar el rendimiento de tus activos a través de estrategias personalizadas y
